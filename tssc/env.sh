...
export IMAGE_URL=${IMAGE_URL-quay.io/redhat-tssc/task-runner:1.8:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/backend-tests-go-wioblxay-gitops
